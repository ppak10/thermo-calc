...
def register_phase_transformation_temperatures(app: FastMCP):
    ...
    from tc.phase_transformation.temperatures import TEMPERATURE_MAX, TEMPERATURE_MIN
    ...
    def phase_transformation_temperatures(
        ...
        phase_transformation_temperatures_path = (
            workspace_path
            / "phase_transformation_temperatures"
            / f"{composition.name}.json"
        )

        try:
            temperatures = compute_phase_transformation_temperatures(
